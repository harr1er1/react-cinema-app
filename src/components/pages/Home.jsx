    ...
    <>
      <div className="banner">
        <div className="banner-title">
          <div className="title-header">КИНОТЕАТР</div>
          <div className="title-subtitle">REACTCINEMA</div>
        </div>
        ...
        <div>
          ...
          <div className="info-text">
            ...
            <div className="text-subtitle">
              REACTCINEMA – это самая большая сеть кинотеатров в Украине
              основанная в 2004 году.
              <br />
              REACTCINEMA - это 28 кинотеатров и 141 кинозал в самых больших
              городах Украины.
              <br />
              Согласно лучшим мировым практикам корпоративного управления, в
              августе 2018 года был сформован высший орган управления компанией
              REACTCINEMA – борд, в состав которого вошли влиятельные украинские
              предприниматели, управленцы и лидеры общественного мнения.
              <br />
              REACTCINEMA активно поддерживает и инвестирует в развитие
            ...
            <ul className="t-list">
              ...
              <li>
                стандартные залы с местами повышенного комфорта на последних
                рядах и инновационные форматы IMAX и ScreenX;
              </li>
      ...
      <div className="wrapper"><SimpleSlider /></div>
    ...
    <div className="controls">
      ...
      <div className="contact-info">
        <div className="block-info">
          <div className="block-title">Фасад</div>
            <img className="photo-block" src={photoCinema} alt="" />
        </div>
        <div className="block-info">
          <div className="block-title">На карте</div>
          <div className="map">
          <YMaps>
            <Map style={{ width: '452px', height: '383px',borderRadius: '10px' }} defaultState={defaultState}>
              <Placemark geometry={[47.993825, 37.860378]} />
              <FullscreenControl />
